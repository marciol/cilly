...
public class TableDump extends PEFile {
    ...
    public void dump(PrintStream out, Table table) {
        ...
        // out.println("\tStart pos in file = 0x" +
        // Long.toHexString(table.start));
    ...
    public void dumpRow(PrintStream out, Table table) {
        ...
        } else if (table instanceof GenericParam) {
            // TODO
            GenericParam t = (GenericParam) table;
            out.print(getString(t.name));
        } else if (table instanceof MethodSpec) {
            // TODO
            MethodSpec t = (MethodSpec) table;
            out.print(bytes2hex(getBlob(t.instantiation)));
        } else if (table instanceof GenericParamConstraint) {
            // TODO
            GenericParamConstraint t = (GenericParamConstraint) table;
        } else {
    ...
    public static void main(String[] args) {
        ...
        if (args.length > 1) {
            nextarg: for (int i = 1; i < args.length; i++) {
                String name = args[i];
